...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
	{ FRAMEWIN_CreateIndirect, "demo", 0                ,   0,   0, 320, 240, FRAMEWIN_CF_MOVEABLE },
	...
	{ TEXT_CreateIndirect,      "jingdu",            0                , 280,   5,  35,  15 },
	{ TEXT_CreateIndirect,      "weidu",             0                , 280, 100,  35,  15 },
};
...
void MainTask(void) {
	...
	hTimer = WM_CreateTimer(hDlg, 0, 1000, 0);
	while (1) {
		GUI_Delay(1000);
	}
}
